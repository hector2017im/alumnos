            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    if (nombre.isEmpty() || apellidoP.isEmpty() || apellidoM.isEmpty()) {
                        ...
                        progeesDialog =  new ProgressDialog(RegistrarAlumnos.this);
    ...
    private class SolicitaDados extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            if (resultado.contains("OK")){
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(RegistrarAlumnos.this);
                builder.setMessage("Alumno Registrado Con Éxito")
                        .setTitle("Éxito");
